 ...
 */
class MultipartStream implements \_PhpScoper5be2fdb7243e7\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoper5be2fdb7243e7\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoper5be2fdb7243e7\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoper5be2fdb7243e7\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
