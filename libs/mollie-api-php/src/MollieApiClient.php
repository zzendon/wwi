...
use _PhpScoper5be2fdb7243e7\GuzzleHttp\Client;
use _PhpScoper5be2fdb7243e7\GuzzleHttp\ClientInterface;
use _PhpScoper5be2fdb7243e7\GuzzleHttp\Exception\GuzzleException;
use _PhpScoper5be2fdb7243e7\GuzzleHttp\Psr7\Request;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoper5be2fdb7243e7\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient ? $httpClient : new \_PhpScoper5be2fdb7243e7\GuzzleHttp\Client([\_PhpScoper5be2fdb7243e7\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoper5be2fdb7243e7\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoper5be2fdb7243e7\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT]);
        $compatibilityChecker = new \Mollie\Api\CompatibilityChecker();
        $compatibilityChecker->checkCompatibility();
        $this->initializeEndpoints();
        $this->addVersionString("Mollie/" . self::CLIENT_VERSION);
        $this->addVersionString("PHP/" . \phpversion());
        $this->addVersionString("Guzzle/" . \_PhpScoper5be2fdb7243e7\GuzzleHttp\ClientInterface::VERSION);
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoper5be2fdb7243e7\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoper5be2fdb7243e7\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoper5be2fdb7243e7\Psr\Http\Message\ResponseInterface $response)
    {
