                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                        <div class="col-3 col-sm-3 col-md-6 text-md-right" style="padding-top: 5px">
                            <h6><strong> Totaal: &#8364; <?php echo $cost; ?> <span class="text-muted"></span></strong>
                            </h6>
                            <h6> prijs: &#8364; <?php echo number_format($price, 2) ?> <span class="text-muted"></span>
                            </h6>
                        ...
                        <div class="col-4 col-sm-4 col-md-4">
                            <div class="quantity">
                                <form method="POST"
                                    ...
                                    <button type="submit" class="btn btn-outline-success btn-xs" style="width:35px">+
                                    </button>
                                </form>
                        ...
                        <div class="col-2 col-sm-2 col-md-2 text-right">
                            <form method="POST" action="../php/shopping_cart/php_session.php?delete_id=<?php echo $index; ?>">
...
<div class="btn btn-success pull-right" style="margin: 10px">
    <div class="pull-right" style="margin: 5px">
        details kosten: <br>
        Product kosten: <b> &#8364; <?php if (!empty($total_product)) {
                echo number_format($total_product, 2);
            } else {
                echo number_format($send_cost, 2);
            } ?></b> <br>
